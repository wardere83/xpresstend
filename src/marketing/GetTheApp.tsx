  ...
  return (
    <section id="get-the-app" className="border-t border-ink-200/70 bg-canvas">
      <div className="mx-auto grid max-w-6xl gap-10 px-5 py-14 md:grid-cols-[1.1fr_1fr] md:items-center">
        <div>
          <h2 className="text-balance text-3xl font-extrabold tracking-tight">{t('app.title')}</h2>
        ...
        <div className="space-y-3">
          <a
            href={APK_URL}
            className="flex items-center gap-4 rounded-[22px] bg-white p-5 ring-1 ring-ink-200/70 transition hover:ring-brand-400"
          >
          ...
          <div className="flex items-center gap-4 rounded-[22px] bg-white p-5 ring-1 ring-ink-200/70 opacity-70">
            <span className="grid h-12 w-12 shrink-0 place-items-center rounded-2xl bg-ink-200 text-ink-500">
              <Apple size={22} />
            </span>
            <span className="min-w-0">
          ...
          <p className="flex items-start gap-2 pt-1 text-[11px] leading-relaxed text-ink-400">
