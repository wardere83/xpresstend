...
export const CORRIDORS: LocalCorridor[] = [
  { id: 'cor_us_ke', receive_country: 'KE', receive_currency: 'USD', send_currency: 'USD', label: 'Kenya',    feePercentBps: 99, fxMarginBps: 0, midRateE8: 100_000_000, minSendMinor: 1000, maxSendMinor: 500_000 },
  ...
  { id: 'cor_us_et', receive_country: 'ET', receive_currency: 'USD', send_currency: 'USD', label: 'Ethiopia', feePercentBps: 99, fxMarginBps: 0, midRateE8: 100_000_000, minSendMinor: 1000, maxSendMinor: 500_000 },
  { id: 'cor_us_br', receive_country: 'BR', receive_currency: 'USD', send_currency: 'USD', label: 'Brazil',   feePercentBps: 99, fxMarginBps: 0, midRateE8: 100_000_000,    minSendMinor: 1000, maxSendMinor: 500_000 },
  { id: 'cor_us_mx', receive_country: 'MX', receive_currency: 'USD', send_currency: 'USD', label: 'Mexico',   feePercentBps: 99, fxMarginBps: 0, midRateE8: 100_000_000,  minSendMinor: 1000, maxSendMinor: 500_000 },
]
