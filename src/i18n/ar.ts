...
export const ar: Record<keyof typeof en, string> = {
  ...
  'recipients.fullName': 'الاسم الكامل للمستلم',
  'recipients.phoneOptional': 'رقم الهاتف (اختياري)',
  'recipients.payoutMethod': 'كيف يستلمون',
  'recipients.addFailed': 'تعذّر حفظ هذا المستلم.',
  'common.save': 'حفظ',
  'common.saving': 'جارٍ الحفظ…',
  'app.title': 'خذه معك.',
  'app.body': 'الحساب نفسه والأسعار نفسها، على هاتفك. أرسل وأنت على المكالمة.',
  'app.point1': 'يُفتح ببصمة وجهك أو إصبعك.',
  'app.point2': 'أكِّد كل تحويل قبل إرساله.',
  'app.point3': 'يعمل بلغتك، التطبيق بأكمله.',
  'app.android': 'التنزيل لأندرويد',
  'app.androidNote': 'أحدث إصدار، يُثبَّت مباشرة',
  'app.ios': 'آيفون',
  ...
  'marketing.navHow': 'كيف يعمل',
  'marketing.navSecurity': 'الأمان',
  'marketing.navPricing': 'التسعير',
  'marketing.trustKicker': 'مصمم لتكون موضع ثقة',
  'marketing.trustTitle': 'الأجزاء من المنتج التي لا تُرى إلا عندما يحدث خطأ ما',
  'marketing.trustBody': 'يكسب منتج التحويلات المالية الثقة من التفاصيل التي لا يراها الزائر أبدًا عندما يسير كل شيء بسلاسة. هذه هي الأربعة التي تدعم هذا المنتج.',
  'marketing.tr1Title': 'مشفّر من طرف إلى طرف',
  'marketing.tr1Body': 'كل تحويل، وكل تفصيل مرتبط به، مشفّر أثناء النقل وفي حالة التخزين — ليس رقم البطاقة فقط.',
  'marketing.tr2Title': 'مسجَّل بنظام القيد المزدوج',
  'marketing.tr2Body': 'يُسجَّل كل تحويل كخصم وائتمان متطابقين. فإما أن توازن الدفاتر، أو لم يحدث التحويل.',
  'marketing.tr3Title': 'شخص محدد بالاسم، لا مساعد آلي',
  'marketing.tr3Body': 'يُسجَّل كل إجراء يقوم به الموظفون على الحساب باسم شخص حقيقي. يمكن للمساعد الذكي أن يقترح؛ لكنه لا يستطيع تحريك الأموال بمفرده.',
  'marketing.tr4Title': 'السعر الذي تراه هو السعر الذي تحصل عليه',
  'marketing.tr4Body': 'تُعرض الرسوم وسعر الصرف قبل التأكيد، ويظلان ثابتين طوال مدة صلاحية العرض. لا مفاجآت في الإيصال.',
  'marketing.howKicker': 'من هنا إلى الوصول',
  'marketing.howTitle': 'ثلاث خطوات. بلا زيارة فرع، من أي جانب.',
  'marketing.step1Title': 'أنشئ حسابك',
  'marketing.step1Body': 'بضع دقائق فقط. تُثبت هويتك أول مرة ترسل فيها فعليًا، لا قبل ذلك.',
  'marketing.step2Title': 'أدخل المبلغ والمستلم',
  'marketing.step2Body': 'اختر ممرًا، وشاهد الرسوم وسعر الصرف فورًا، ثم اختر كيف سيستلمها.',
  'marketing.step3Title': 'يستلمها المستلم',
  'marketing.step3Body': 'تصل معظم التحويلات في نفس اليوم. يمكنك تتبع كل خطوة من هاتفك حتى تصل.',
  'marketing.saveKicker': 'ما الذي يكلفه الأمر فعليًا',
  'marketing.saveTitle': 'رسم ثابت واحد. لا هامش خفي في سعر الصرف.',
  'marketing.saveBody': 'غالبًا ما يُفرض على التحويلات المصرفية الدولية رسمان: رسم ثابت ظاهر، وهامش خفي مضمّن في سعر الصرف. يفرض هذا المنتج رسمًا واحدًا فقط.',
  'marketing.saveNote': 'مثال توضيحي لتحويل بقيمة 500 دولار. أرقام البنوك هي رسم تحويل نموذجي بالإضافة إلى هامش صرف نموذجي، وليست عرض سعر من بنك معين.',
  'marketing.saveExample': 'إرسال 500 دولار',
  'marketing.saveBankLabel': 'تحويل مصرفي نموذجي',
  'marketing.saveUsLabel': '{brand}',
  'marketing.saveKeepMore': 'يصل المزيد من مبلغ الـ 500 دولار',
  'marketing.footerAbout': 'منتج تحويل أموال برسم ثابت، صُمم بحيث يكون السعر المعروض هو السعر الذي تدفعه — لا يُضاف شيء في النهاية.',
  'marketing.footerCompany': 'الشركة',
