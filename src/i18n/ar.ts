...
export const ar: Record<keyof typeof en, string> = {
  ...
  'help.a5':
    '{brand} مسجَّلة في النظام الوطني لترخيص الولايات المتعددة (NMLS)، رقم NMLS {nmls}، ومقرها {city}، {state}. تُنشر حالة الترخيص الحالية لكل ولاية على nmlsconsumeraccess.org. كل تحويل مشفَّر أثناء النقل، ولا تتحرك أي أموال حتى تؤكّدها بكلمة المرور الخاصة بك.',
  ...
  'marketing.disclaimer':
    '{brand} Financial Services مسجَّلة في النظام الوطني لترخيص الولايات المتعددة (NMLS)، رقم NMLS {nmls}، ومقرها {city}، {state}. تعمل المدفوعات حاليًا في وضع الاختبار: لا تُنقل أموال العملاء ولا تُخصم أي بطاقة أو حساب بنكي.',
  ...
  'app.demoBadge': 'عرض تجريبي — بيانات نموذجية',
  ...
  'pay.mobileMoney': 'المحفظة الإلكترونية',
  'rail.accountLabel': 'رقم المحفظة الذي سيتم الدفع منه',
  'rail.accountHint': 'الرقم الذي تُخصم منه الأموال. يُرسل إلى مزوّد الدفع ولا تخزّنه XpressTend إطلاقًا.',
  'rail.pinLabel': 'رمز المحفظة (إذا طلبه مزوّدك)',
  'rail.pinHint': 'اتركه فارغًا إذا كان مزوّدك يرسل طلب الموافقة إلى هاتفك.',
  'rail.pending': 'بانتظار موافقتك على الدفع من هاتفك.',
  'rail.pendingBody': 'أرسل مزوّدك طلبًا إلى {account}. وافق عليه هناك وستتحدّث هذه الصفحة. لم يُخصم أي مبلغ بعد.',
  'rail.checkAgain': 'تحقّق مرة أخرى',
  'rail.declined': 'رفض مزوّد الدفع عملية الدفع هذه.',
  'rail.unavailable': 'المحفظة الإلكترونية غير متاحة حاليًا.',
  'rail.accountRequired': 'أدخل رقم المحفظة الذي سيتم الدفع منه.',
  'status.awaitingPayment': 'بانتظار الدفع',
  'status.inReview': 'قيد مراجعة الامتثال',
