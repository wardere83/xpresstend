...
export const so: Record<keyof typeof en, string> = {
  ...
  'marketing.navHow': 'Sida ay u shaqeyso',
  'marketing.navSecurity': 'Amniga',
  'marketing.navPricing': 'Qiimaha',
  'marketing.trustKicker': "Loo dhisay in lagu kalsoonaado",
  'marketing.trustTitle': 'Qaybaha alaabta aan la arki karin ilaa wax khaldamo',
  'marketing.trustBody': 'Nidaamka wareejinta lacagta wuxuu ka helaa kalsoonida faahfaahinta aan booqdaha weligiis arkin marka wax walba si fiican u socdaan. Kuwan waa afarta taageeraya nidaamkan.',
  'marketing.tr1Title': 'Sirta laga ilaaliyay bilowga ilaa dhammaadka',
  'marketing.tr1Body': 'Wareejin kasta, iyo faahfaahin kasta oo la xiriirta, waxay sitaa sirta xilliga la gudbinayo iyo marka la kaydinayo — kama dambaysa lambarka kaadhka oo keliya.',
  'marketing.tr2Title': 'Xisaabaadka laba-geesood ah',
  'marketing.tr2Body': 'Wareejin kasta waxay u diiwaan gashantahay sida daynta iyo kaalinta isku mid ah. Ama xisaabta way isku dheellitirantaa, ama wareejintu ma dhicin.',
  'marketing.tr3Title': 'Qof la magacaabay, ma aha wakiil',
  'marketing.tr3Body': 'Ficil kasta oo shaqaaluhu ku qaadaan koontada waxaa lagu diiwaan geliyaa magaca qof dhab ah. Kaaliyaha AI wuxuu soo jeedin karaa; ma qaadan karo lacagta isaga keligiis.',
  'marketing.tr4Title': 'Qiimaha aad aragto waa qiimaha aad heshid',
  'marketing.tr4Body': "Khidmadda iyo qiimaha sarrifka waxaa lagu muujiyaa ka hor inta aan la xaqiijin, waxayna sii ahaadaan sidoodii intii uu qiimaha ansax ahaanayo. Lama helo wax lays yaabo ah rasiidhka.",
  'marketing.howKicker': 'Halkan ilaa gaadhista',
  'marketing.howTitle': "Saddex tallaabo. Lama booqdo laan, dhinac kastaba.",
  'marketing.step1Title': 'Samee koontadaada',
  'marketing.step1Body': 'Dhawr daqiiqo. Waxaad xaqiijisaa aqoonsigaaga markii aad markii ugu horreysa dhab ahaan u dirto, kama hor.',
  'marketing.step2Title': 'Geli qadar iyo qof aad u dirayso',
  'marketing.step2Body': "Dooro waddo (corridor), arag khidmadda iyo qiimaha isla markiiba, kadibna dooro sida uu ku helayo.",
  'marketing.step3Title': 'Wuu helayaa',
  'marketing.step3Body': 'Wareejin badan waxay gaadhaan isla maalintaas. Waxaad la socon kartaa tallaabo kasta taleefankaaga ilaa ay gaadho.',
  'marketing.saveKicker': 'Waxa ay dhab ahaan ku kacayso',
  'marketing.saveTitle': "Hal khidmad oo go'an. Ma jiro qiimo qarsoon oo ku jira sarrifka.",
  'marketing.saveBody': "Wareejinta bangiga caalamiga ah badanaa waxaa lagu qiimeeyaa laba jeer: mar khidmad go'an oo la arki karo, iyo mar kale qiimo qarsoon oo ku dhex jira sarrifka. Alaabtan waxay ku qiimeysaa hal mar.",
  'marketing.saveNote': "Tusaale sharaxaad ah oo loogu talagalay wareejin $500 ah. Tirooyinka bangiyada waa khidmad wareejin caadi ah oo lagu daray qiimo sarrifka caadiga ah, kama socdaan qiimo bangi gaar ah.",
  'marketing.saveExample': 'Diritaanka $500',
  'marketing.saveBankLabel': 'Wareejinta bangiga caadiga ah',
  'marketing.saveUsLabel': '{brand}',
  'marketing.saveKeepMore': "In ka badan $500-kaaga ayaa gaadha",
  'marketing.footerAbout': "Waa alaab wareejin lacag oo leh khidmad go'an, loo dhisay si qiimaha lagu siiyay uu noqdo qiimaha aad bixiso — waxba lagama darin dhammaadka.",
  'marketing.footerCompany': 'Shirkadda',
  'marketing.footerSupport': 'Taageero',
}
