...
export const so: Record<keyof typeof en, string> = {
  ...
  'marketing.disclaimer': 'XpressTend waa beta gaar ah. Lacag-bixinta waa qaab tijaabo, lacag macmiilna lama dirayo ilaa shatiga iyo shariig lacag-bixin la helo.',
  ...
  'app.iosBetaNote': 'Ku biir tijaabada TestFlight',
