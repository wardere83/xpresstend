...
export const es: Record<keyof typeof en, string> = {
  ...
  'marketing.disclaimer':
    '{brand} Financial Services está registrada en el Nationwide Multistate Licensing System, NMLS ID {nmls}, con sede en {city}, {state}. Los pagos se ejecutan actualmente en modo de prueba: no se mueven fondos de clientes ni se cobra ninguna tarjeta o cuenta bancaria.',
  ...
  'app.demoBadge': 'Vista de demostración — datos de ejemplo',
  'nav.downloadApp': 'Descargar la app',
  ...
  'pay.mobileMoney': 'Dinero Móvil',
  'rail.accountLabel': 'Número de dinero móvil desde el que pagar',
  'rail.accountHint': 'El número del que se toma el dinero. Se envía al proveedor de pagos y XpressTend nunca lo almacena.',
  'rail.pinLabel': 'PIN de la billetera (si su proveedor lo pide)',
  'rail.pinHint': 'Déjelo en blanco si su proveedor envía la aprobación a su teléfono.',
  'rail.pending': 'Esperando a que apruebe el pago en su teléfono.',
  'rail.pendingBody': 'Su proveedor envió una solicitud a {account}. Apruébela allí y esta página se actualizará. Aún no se ha cobrado nada.',
  'rail.checkAgain': 'Comprobar de nuevo',
  'rail.declined': 'El proveedor de pagos rechazó ese pago.',
  'rail.unavailable': 'El dinero móvil no está disponible en este momento.',
  'rail.accountRequired': 'Introduzca el número de dinero móvil desde el que pagar.',
  'status.awaitingPayment': 'Pendiente de pago',
  'status.inReview': 'En revisión de cumplimiento',
