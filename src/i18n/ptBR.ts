...
export const ptBR: Record<keyof typeof en, string> = {
  ...
  'marketing.disclaimer':
    'A {brand} Financial Services está registrada no Nationwide Multistate Licensing System, NMLS ID {nmls}, com sede em {city}, {state}. Os pagamentos funcionam atualmente em modo de teste: nenhum recurso de cliente é movimentado e nenhum cartão ou conta é cobrado.',
  ...
  'app.demoBadge': 'Prévia de demonstração — dados de exemplo',
  'nav.downloadApp': 'Baixar o app',
  ...
  'pay.mobileMoney': 'Dinheiro Móvel',
  'rail.accountLabel': 'Número de dinheiro móvel para pagar',
  'rail.accountHint': 'O número de onde o dinheiro sai. Vai para o provedor de pagamentos e nunca é armazenado pela XpressTend.',
  'rail.pinLabel': 'PIN da carteira (se o seu provedor pedir)',
  'rail.pinHint': 'Deixe em branco se o seu provedor enviar a aprovação para o seu telefone.',
  'rail.pending': 'Aguardando que você aprove o pagamento no seu telefone.',
  'rail.pendingBody': 'Seu provedor enviou uma solicitação para {account}. Aprove lá e esta página será atualizada. Nada foi cobrado ainda.',
  'rail.checkAgain': 'Verificar novamente',
  'rail.declined': 'O provedor de pagamentos recusou esse pagamento.',
  'rail.unavailable': 'Dinheiro móvel indisponível no momento.',
  'rail.accountRequired': 'Informe o número de dinheiro móvel para pagar.',
  'status.awaitingPayment': 'Aguardando pagamento',
  'status.inReview': 'Em análise de conformidade',
